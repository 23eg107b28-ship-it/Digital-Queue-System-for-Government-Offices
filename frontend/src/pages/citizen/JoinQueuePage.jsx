  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[1fr_420px]">
      <div>
        ...
        <Paper className="rounded-3xl p-6" sx={{ background: "rgba(15,23,42,0.75)" }}>
          <form className="grid gap-4" onSubmit={submit}>
            ...
            <Paper variant="outlined" className="rounded-2xl p-4" sx={{ background: "rgba(2,6,23,0.4)", borderColor: "rgba(45,212,191,0.2)" }}>
      ...
      <div>
        ...
        {mutation.data ? <TokenStatusCard token={mutation.data} /> : <Paper className="rounded-3xl p-6" sx={{ background: "rgba(15,23,42,0.75)" }}>Your generated token will appear here.</Paper>}
      </div>
    </div>
  );
}
